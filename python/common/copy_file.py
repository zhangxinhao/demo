...
def move_files(source_dir, target_dir):
    ...
    for filename in os.listdir(source_dir):
        ...
        if os.path.isfile(full_file_path) and filename.endswith('.pdf'):
...
if __name__ == '__main__':
    ...
    move_files('/Users/zhangxinhao/Downloads/rust/161rust', '/Users/zhangxinhao/Downloads/rust/pdf')
    # change_file_name('/Users/zhangxinhao/Downloads/rust/md')
